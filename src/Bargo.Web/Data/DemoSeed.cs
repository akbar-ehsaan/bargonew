...
public static class DemoSeed
{
    ...
    public static async Task RunAsync(BargoDbContext db)
    {
        ...
        // ---------------- خودروها ----------------
        var v1 = new Vehicle { PlateNo = "12ع345-11", VehicleTypeId = T("تریلی چادری").VehicleTypeId, Brand = "ولوو", Model = "FH500", Year = 2019, CapacityTon = 24, DriverId = d1.DriverId, VehicleCardNo = "VC-1001", InsurancePolicyNo = "INS-77001", InsuranceExpiresAt = now.AddDays(18), InspectionExpiresAt = now.AddDays(120), VerifyStatus = AccountStatus.Approved, LastLat = 35.66, LastLng = 51.30, LastSeenAt = now.AddMinutes(-4) };
        var v2 = new Vehicle { PlateNo = "54ب678-13", VehicleTypeId = T("کامیون تک یخچالی").VehicleTypeId, Brand = "بنز", Model = "2624", Year = 2015, CapacityTon = 10, DriverId = d2.DriverId, VehicleCardNo = "VC-1002", InsuranceExpiresAt = now.AddDays(90), InspectionExpiresAt = now.AddDays(-3), VerifyStatus = AccountStatus.Approved, LastLat = 34.10, LastLng = 51.25, LastSeenAt = now.AddMinutes(-2) };
        var v3 = new Vehicle { PlateNo = "33ج112-36", VehicleTypeId = T("کامیون جفت بغل‌باز").VehicleTypeId, Brand = "اسکانیا", Year = 2012, CapacityTon = 18, DriverId = d3.DriverId, VerifyStatus = AccountStatus.Pending };
        var cv1 = new Vehicle { PlateNo = "77د441-10", VehicleTypeId = T("تریلی کفی").VehicleTypeId, Brand = "داف", Model = "XF", Year = 2020, CapacityTon = 24, CompanyId = co.CompanyId, VehicleCardNo = "VC-2001", InsuranceExpiresAt = now.AddDays(210), InspectionExpiresAt = now.AddDays(160), VerifyStatus = AccountStatus.Approved, LastLat = 35.70, LastLng = 51.42, LastSeenAt = now.AddMinutes(-1) };
        var cv2 = new Vehicle { PlateNo = "19هـ802-20", VehicleTypeId = T("تریلی یخچالی").VehicleTypeId, Brand = "ولوو", Year = 2018, CapacityTon = 22, CompanyId = co.CompanyId, VehicleCardNo = "VC-2002", InsuranceExpiresAt = now.AddDays(25), InspectionExpiresAt = now.AddDays(300), VerifyStatus = AccountStatus.Approved };
